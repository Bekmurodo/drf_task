...
class ChangeUserInformation(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if password != confirm_password:
            raise ValidationError(
                {
                    "message": "Parolingiz va tasdiqlash porolingiz bir xil emas"
                }
            )
        if password:
    ...
    def validate_firs_name(self, first_name):
    ...
    def update(self, instance, validated_data):
        ...
        if validated_data.get('password'):
            instance.set_password(validated_data.get('password'))# passwordni xeshlayaomiz set_password orqali
...
class LoginSerializer(TokenObtainPairSerializer):
    ...
    def auth_validate(self, data):
        ...
        if check_user_type(user_input) == 'username':
            ...
            data = {
                "success": True,
                "message": "Siz username yoki telefon raqami kiritishingiz kerak."
            }
            raise ValidationError(data)
    ...
    def validate(self, data):
        ...
        data['first_name'] = self.user.full_name
        return data
...
class ForgotPasswordSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        user = User.objects.filter(Q(phonenumber=email_or_phone) | Q(email=email_or_phone))
        if not user.exists():
    ...
    def validate(self, data):
        ...
        if password != confirm_password:
            raise ValidationError(
                {
                    "success": False,
                    "message": "Parolingiz bir-biriga teng emas!"
                }
            )
        if password:
            validate_password(password)
